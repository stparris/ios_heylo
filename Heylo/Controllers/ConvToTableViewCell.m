...
@implementation ConvToTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-20-[messageView][avatarView]-20-|" options:0 metrics:nil views:viewsDictionary]];
        ...
        [self.avatarView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[pointer]-20-|" options:0 metrics:nil views:viewsDictionary]];
        ...
        [self.avatarView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[avatar(30)]" options:0 metrics:nil views:viewsDictionary]];
...
- (void)layoutSubviews
{
    ...
    [avatarLayer setCornerRadius:14.0];
